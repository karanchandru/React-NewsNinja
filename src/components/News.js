...
export class News extends Component {
 ...
 async componentDidMount(){
     let url=`https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=82375203c639443fb887e14666d06249&page=1&pageSize=${this.props.pageSize}`;
 ...
 handlePrevClick = async ()=>{
     ...
     let url=`https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=82375203c639443fb887e14666d06249&page=${this.state.page -1}&pageSize=${this.props.pageSize}`;
     this.setState({loading:true});
     let data=await fetch(url);
     let parsedData=await data.json();     
     this.setState({
 ...
 handleNextClick= async ()=>{
  ...
  render() {
    ...
    <div className="container my-3">
        <h1 className="text-center">NewsNenja  -Top Headline</h1>
